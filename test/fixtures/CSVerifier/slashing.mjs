...
import CSVerifierSlashingTest from "../../../out/CSVerifier.t.sol/CSVerifierSlashingTest.json" assert { type: "json" };
...
function main(opts) {
  ...
  const ffi_interface = CSVerifierSlashingTest.abi.find((e) => e.name == "ffi_interface");
