...
import CSVerifierHistoricalBase from "../../../out/CSVerifierHistorical.t.sol/CSVerifierHistoricalBase.json" assert { type: "json" };
...
function main(opts) {
  ...
  const ffi_interface = CSVerifierHistoricalBase.abi.find((e) => e.name == "ffi_interface");
