...
import CSVerifierWithdrawalTest from "../../../out/CSVerifier.t.sol/CSVerifierWithdrawalTest.json" assert { type: "json" };
...
function main(opts) {
  ...
  const ffi_interface = CSVerifierWithdrawalTest.abi.find((e) => e.name == "ffi_interface");
